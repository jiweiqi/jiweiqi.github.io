...
- [BibTeX bibliography](publications.bib)
...
Search the local collection with standard text-search tools, or open it as a research workspace in Codex. Consult the PDFs for equations, figures and tables whose formatting may not survive text extraction.

The website is static HTML and works without JavaScript. JavaScript adds optional publication search and topic filtering.
