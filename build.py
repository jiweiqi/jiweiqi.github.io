...
BIO = 'Founder of SVD Lab. Previously, I was a Senior Research Scientist at Bosch and Apple, following postdoctoral research at MIT. I received my PhD from Tsinghua University.'
...
<p class="bio">{BIO.replace('SVD Lab', '<a href="https://svdailab.com">SVD Lab</a>')}</p><p>{RESEARCH}</p>
...
<p class="results-status" id="results-status" role="status" aria-live="polite">{len(PAPERS)} publications</p><noscript><p>All publications are listed below. Use your browser’s Find command to search this page.</p></noscript><p id="empty-state" class="empty" hidden>No publications match this search. Try a different method or clear the research-area filter.</p>'''
    ...
    person={'@context':'https://schema.org','@type':'ProfilePage','mainEntity':{'@type':'Person','name':'Weiqi Ji','url':ORIGIN,'description':BIO+' '+RESEARCH,'jobTitle':'Founder','worksFor':{'@type':'Organization','name':'SVD Lab','url':'https://svdailab.com'},'alumniOf':{'@type':'CollegeOrUniversity','name':'Tsinghua University'},'sameAs':['https://orcid.org/0000-0002-7097-0219','https://people.ucas.ac.cn/~0084227','https://github.com/jiweiqi',LINKEDIN],'knowsAbout':['Scientific machine learning','Uncertainty quantification','Active subspaces','Sensitivity analysis','Chemical kinetics']}}
